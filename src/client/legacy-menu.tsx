...
import { OpenInMenuRow, type OpenInMenuRowProps } from './rows.tsx'
...
const MOUNT_ATTR = 'data-dsh-open-in-legacy'
...
function cancelPointerLeaveClose(anchor: HTMLElement): void {
  ...
  // event tree. Our compatibility rows are a nested React root, so entering
  // them otherwise looks like leaving that tree and the menu closes after 200ms.
